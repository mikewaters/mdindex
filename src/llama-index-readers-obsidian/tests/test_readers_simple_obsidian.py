...
from llama_index.readers.obsidian import SimpleObsidianReader


def test_class():
    names_of_base_classes = [b.__name__ for b in SimpleObsidianReader.__mro__]
...
def test_file_metadata(tmp_path: Path):
    ...
    reader = SimpleObsidianReader(input_dir=str(tmp_path))
