...
class TestCollectionCreate:
    ...
    def test_create_collection(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_create_collection_default_pattern(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
        """Create should use default glob pattern."""
        collection = collection_repo.create("notes", str(tmp_path))

        assert collection.glob_pattern == "**/*.md"

    def test_create_collection_custom_pattern(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_create_duplicate_raises(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_create_sets_timestamps(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
...
class TestCollectionGet:
    ...
    def test_get_by_name_exists(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_get_by_name_not_exists(self, collection_repo: SourceCollectionRepository):
        """get_by_name should return None if not exists."""
        found = collection_repo.get_by_name("nonexistent")

        assert found is None

    def test_get_by_id_exists(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_get_by_id_not_exists(self, collection_repo: SourceCollectionRepository):
...
class TestCollectionListAll:
    ...
    def test_list_all_empty(self, collection_repo: SourceCollectionRepository):
        """list_all should return empty list when no collections."""
        collections = collection_repo.list_all()

        assert collections == []

    def test_list_all_single(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_list_all_multiple(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_list_all_ordered_by_name(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
...
class TestCollectionRename:
    ...
    def test_rename_success(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_rename_updates_timestamp(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_rename_same_name(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_rename_to_existing_raises(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_rename_nonexistent_raises(self, collection_repo: SourceCollectionRepository):
...
class TestCollectionRemove:
    ...
    def test_remove_success(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_remove_returns_counts(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_remove_nonexistent_raises(self, collection_repo: SourceCollectionRepository):
...
class TestCollectionUpdatePath:
    ...
    def test_update_path_success(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_update_path_with_pattern(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
    ...
    def test_update_path_nonexistent_raises(self, collection_repo: SourceCollectionRepository):
        """update_path on nonexistent should raise."""
        with pytest.raises(SourceCollectionNotFoundError):
            collection_repo.update_path(99999, "/new/path")

    def test_update_path_updates_timestamp(self, collection_repo: SourceCollectionRepository, tmp_path: Path):
